...
class Run extends Command
{
    ...
    protected function configure()
    {
        $this->setName('run')
            ...
            ->addOption('host', 's', InputOption::VALUE_OPTIONAL, 'host to server', "localhost")
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $command = sprintf(
            'php -S %s:%d -t %s %s',$host,$port,escapeshellarg($path),escapeshellarg($path . DIRECTORY_SEPARATOR . 'index.php')
        );
