...
class Error{
    ...
    public static function runError($errno = 2,$errstr = 'Undefined Error',$errfile = 'Undefined Error',$errline = 0){
      $throwError = new ThrowError($errstr,$errfile,$errline,$errorcode="System Error",$errtitle="系统因错误意外终止",$errno=2);
        return true;
    }
    public static function runException($e){
        ...
        $errno = $e->getCode();
        $errTrace = $e->getTrace();
        $throwError = new ThrowError($errstr,$errfile,$errline,$errorcode="System Exception",$errtitle="系统因错误意外终止",$errno=2);
        return true;
    }
